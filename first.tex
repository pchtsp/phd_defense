...
\frametitle{\textbf{Complexity analysis}}
  ...
  \onslide<+->{
    Becomes the NP-Complete Shift Satisfaction Personnel Task Scheduling Problem first presented in \cite{Arkin1987}.
  }    
\end{frame}
...
\frametitle{\textbf{Results}}
  ...
  \only<1>{
    \includegraphics[width=0.8\linewidth]{images/clust_params2_cplex_gaps.png}
  }
  \only<2>{
    \includegraphics[width=0.8\linewidth]{images/clust_params2_cplex_times.png}
  }
\end{frame}
