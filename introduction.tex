...
\frametitle{\textbf{The Military Flight and Maintenance Planning (MFMP) problem}}
  ...
  \begin{textblock*}{\textwidth}(0.8cm, 8cm)
    ...
    % $\star$
    \onslide<3->{
      \citesize $\star$ R. A. Hahn and A. M. Newman. Scheduling United States Coast Guard helicopter deployment and maintenance at Clearwater Air Station, Florida. Computers and Operations Research, 35(6):1829–1843, jun 2008. 
    }
    \end{flushleft}
  \end{textblock*}
\end{frame}
