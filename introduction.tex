...
\frametitle{\textbf{An Military Flight and Maintenance Planning (MFMP) problem}}
  ...
  \onslide<5->{
    \begin{block}{\textbf{Objective}}
      Use the least maintenances / delay them as much as possible.
    \end{block}  
  }
\end{frame}

\begin{frame}
\frametitle{\textbf{An MFMP solution}}
  % TODO: legend with flight hours. 
  % TODO: animation with aircraft, periods, maintenances, missions
