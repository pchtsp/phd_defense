...
\begin{ganttchart}[
    ...
    \onslide<1-2>{
      ...
      \ganttbar[bar/.append style={draw=none}, inline, bar label font=\tiny\bfseries]{$U^{min}$}{1}{1}
      \ganttbar[bar/.append style={draw=none}, inline, bar label font=\tiny\bfseries]{$U^{min}$}{4}{4}
      \ganttbar[bar/.append style={draw=none}, inline, bar label font=\tiny\bfseries]{$U^{min}$}{9}{9}
      \ganttbar[bar/.append style={draw=none}, inline, bar label font=\tiny\bfseries]{$U^{min}$}{10}{10}
      \ganttbar[bar/.append style={draw=none}, inline, bar label font=\tiny\bfseries]{$U^{min}$}{11}{11}
      \ganttbar[bar/.append style={draw=none}, inline, bar label font=\tiny\bfseries]{$U^{min}$}{12}{12}
      \ganttbar[bar/.append style={draw=none}, inline, bar label font=\tiny\bfseries]{$U^{min}$}{13}{13}
      \ganttbar[bar/.append style={draw=none}, inline, bar label font=\tiny\bfseries]{$U^{min}$}{14}{14}
      \ganttbar[bar/.append style={draw=none}, inline, bar label font=\tiny\bfseries]{$U^{min}$}{15}{15}
